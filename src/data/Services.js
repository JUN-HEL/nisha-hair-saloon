...
export const BoysServices = [
  {
    ...
    featured: true,
    description:
      "Modern fades, classic cuts, and personalized hairstyles crafted by professional barbers.",
    includes: [
      "Hair Consultation",
      "Precision Haircut",
      "Hair Wash",
...

  {
    ...
    featured: true,
    description:
      "Sharp beard shaping and grooming designed to match your face structure.",
    includes: [
      "Beard Trim",
      "Shape & Line Up",
      "Hot Towel Finish",
...

  {
    ...
    featured: true,
    description:
      "Premium hair coloring services with modern shades and natural-looking results.",
    includes: [
      "Color Consultation",
      "Premium Hair Color",
      "Hair Wash",
  ...
  /* {
    ...
    featured: false,
    description:
      "A complete men's grooming experience for a fresh and confident appearance.",
    includes: [
      "Haircut",
      "Beard Styling",
      "Face Cleanup",
...

  {
    ...
    featured: false,
    description:
      "Deep cleansing facial treatment designed for healthy and refreshed skin.",
    includes: [
      "Face Cleanup",
      "Skin Treatment",
      "Relaxing Massage",
...

  {
    ...
    featured: true,
    description:
      "Professional styling for parties, events, and special occasions.",
    includes: [
      "Hair Styling",
      "Texture Finish",
      "Premium Products",
...

  {
    ...
    image: "/images/services/mens/mens-hair-low-fade.webp",
    price: 399,
    popular: false,
    featured: false,
    description:
...

  {
    ...
    featured: false,
    description:
      "Professional beard trimming and grooming for a clean, sharp, and well-defined appearance.",
    includes: [
      "Beard Consultation",
...

  {
    ...
    featured: true,
    description:
      "Modern taper fade haircut with seamless blending, crisp edges, and a polished professional finish.",
    includes: [
      "Consultation",
      "Taper Fade",
      "Precision Line Up",
...

  {
    ...
    featured: true,
    description:
      "Sharp high fade haircut featuring smooth blending, clean sides, and a stylish textured top.",
    includes: [
      "Hair Consultation",
      "High Fade",
      "Precision Finish",
